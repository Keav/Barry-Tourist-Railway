...
<div class="news-item-row">
    ...
    <div class="grid_8">
        ...
        <div class="container img-center">
            <img src="images/jb_valleylines_cab.jpg" alt="John Buxton in the Cab of a Pacer train">
...
<div class="news-item-row">
    ...
    <div class="grid_8">
        ...
        <p>The Glamorgan Wartime Heritage Centre was officially opened for the 2013 season. The museum, now completed, was available for the public to inspect and 10 stalls selling collectable militaria did a brisk business. The centre will be open every second Sunday of each month throughout the year and also on the dates shown on our events page when the Barry Tourist Railway will also be operating.</p>

        <p>For more information about the Glamorgan Wartime Heritage Centre, phone Ade Pitman on 07930 874161 or visit the website at <a href="http://www.barryatwar.info">www.barryatwar.info</a>.</p>
    </div>
    <br style="clear:left;"/>&nbsp;
</div>
...
<div class="news-item-row">
    ...
    <div class="grid_8">
        ...
        <p>The &#39;Glamorgan Wartime Heritage Centre&#39; has been chosen as the name for the Barry at War run facility located at the Barry Tourist Railway Station, Barry Island.</p>

        <p>Group Chairman, Ade Pitman explained the name, saying, &#34;Although our group name suggests that we are only interested in the history of Barry town, our research actually spans the entire length of South Wales.</p>

        <p>Popular with people on our Facebook page, the name &#39;Glamorgan Wartime Heritage Centre&#39; helps to portray the inclusive nature of the facility.</p>

        <p>Not only will it be used to gather and share the wartime memories of local people, but it will also signpost heritage tourists and interested people, to the region&#39;s other military history locations such as the many rare Second World War bunkers dotted along the Glamorgan coastline, the Island Farm prisoner of war camp near Bridgend, Llandow Airfield and other museums.</p>

        <p>Ultimately we aim to create a facility that can provide support to the many groups and individuals who have an interest in this area of history, and one that will provide an easily accessible learning facility for local schools.&#34;</p>

        <p>Ade continued, &#34;Following the success of this summer&#39;s Wartime Weekend, planning has already begun for next year&#39;s event, and the Glamorgan Wartime Heritage Centre will be a key part.&#34;</p>

        <p>The Glamorgan Wartime Heritage Centre will be holding an Open Day on Sunday November 4th, at the Barry Tourist Railway Station, Barry Island.</p>

        <p>The event will feature a military bazaar, radio-controlled tanks, lectures and displays. Admission is free, and the doors open at 10 am.</p>

        <p>Call Ade Pitman on 07930 874161 or see the Barry at War website at <a href="www.barryatwar.info">www.barryatwar.info</a> for more information.</p>
        </p>
    </div>
    <br style="clear:left;"/>&nbsp;
</div>
...
<div class="news-item-row">
    ...
    <div class="grid_8">
        ...
        <p>Barry Tourist Railway, supporting the Barry Wartime Weekend, is celebrating a successful 1940s wartime weekend, which saw GWR Steam Locomotive 9466 in action alongside 1940s re-enactors from across the Country.</p>

        <p>John Buxton, Managing Director of Barry Tourist Railway, said "The weekend is a real cause for celebration for us at Barry Tourist Railway, and we were delighted to have worked so closely with the Barry Wartime Weekend organisers in bringing forward this very special event."</p>

        <p>The weekend brought history to life, with both military and civilian re-enactors, as well as period army vehicles, and historical exhibitions, alongside the GWR steam locomotive 9466. Vale of Glamorgan Assembly Member Jane Hutt was amongst the many dignitaries that visited the event.</p>

        <p>Mr Buxton added, "These are the kind of events that we at Barry Tourist Railway will continue to bring to Barry, and, judging by the fantastic reaction that the people of Barry and the many visitors to the Town gave this event, we know that the Town will continue to support us."</p>

        <p>Barry Tourist Railway runs a mixture of steam and diesel services throughout the year.</p>
    </div>
    <br style="clear:left;"/>&nbsp;
</div>
...
<div class="news-item-row">
    ...
    <div class="grid_8">
        ...
        <p>Two Black 5s arrived at the Barry Rail Centre via its mainline connection this week.  The steam locomotives, numbers 44871 and 45407 &#39;The Lancashire Fusilier&#39;, are mainline certified and brought passengers from Crewe via the Central Wales Line to South Wales in a charter service.</p>

        <p>The locomotives arrived at Barry Rail Centre for servicing and storage on Sunday night, and will spend the week at Barry before leaving to haul further passenger charter services. This is the first time that steam locomotives have used the mainline connection to access Barry Rail Centre Main Depot from the National Rail Network lines since 1965, and is the first use of the connection by preserved steam.</p>

        <p>John Buxton, Managing Director of Barry Rail Centre, said "These are the first mainline steam hauled passenger trains to arrive at Barry Rail Centre via our mainline connection, and they are a recognition of our excellent facilities in this part of the country. At Barry we have plenty of covered accommodation and are able to keep the two locos and support coach under cover in our Main Depot Shed."</p>

        <p>Barry Rail Centre is a professionally run railway engineering, maintenance, storage and training facility in South Wales, and is mainline connected.</p>

        <p>Mr Buxton added, "At Barry Rail Centre we have a programme of investment to continually improve our facilities to clients, and we are for example about to begin work on installing a turntable on the site. We are confident that more passenger tour operators will avail themselves of this unique facility at Barry and use our excellent facilities at our Main Depot in the future. At Barry we can offer full servicing of steam locomotive and passenger train facilities."
        The Centre is on a long term lease to Cambrian Transport, who are developing a site with a mixture of commercial rail services and tourist railway operations, which is a little over 100 acres in size.</p>

        <p>John Buxton added, "Our business plan for Barry will develop employment and skills training for local people, increased tourism though our tourist railway operations, and help further the regeneration of the Town through our investment in the site."</p>

        <p>On the site, leased from the local authority The Vale of Glamorgan Council, Cambrian Transport has developed a commercial facility known as Barry Rail Centre, and a tourist focused operation known as Barry Tourist Railway.</p>
    </div>
    <br style="clear:left;"/>&nbsp;
</div>
...
<div class="grid_8">
    ...
    <p>The first successful passenger services to be hauled by refurbished Class 26 Locomotive 26038 were a success during the bank holiday weekend 6th and 7th May at the Barry Tourist Railway.</p>

    <p>Operating together with Class 73 Locomotive 73118, and Mk 2f passenger coaches from the former Gatwick Express, the Class 26 provided a major draw for families and train enthusiasts from across the UK.</p>

    <p>Barry Tourist Railway Chairman, John Buxton, said "We were delighted with the response from the public and pleased to welcome so many passengers to the railway. This was a highly successful weekend, and we were pleased that Tom Clift was able to bring his locomotive to Barry for its first passenger hauled services since he and his team refurbished it."</p>

    <p>The Class 26 was withdrawn from service in 1992, and has now been refurbished. Locomotive owner Tom Clift, said "We were pleased to bring the locomotive to Barry Tourist Railway, where the locomotive has been undergoing final testing and commissioning work over the last couple of months prior to the bank holiday services. I am pleased that it operated so well and that there was so much interest in it from train enthusiasts and members of the public."</p>
</div>
<br style="clear:left;"/>&nbsp;
</div>
